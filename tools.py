...
def str_compare(s1: str, s2: str, ignore_case=True):
    s1 = normalize_str(s1)
    s2 = normalize_str(s2)
    if ignore_case:
        s1 = s1.lower()
...
def file_to_base64(image_path: str):
